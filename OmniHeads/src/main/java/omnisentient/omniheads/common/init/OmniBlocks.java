...
public final class OmniBlocks
{
	...
	public static final Block 
		...
		// LIGHTING
		CEILING_FLAT_LIGHT = add("ceiling_flat_light", OmniItems.LIGHTING_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.GLASS).lightValue(15), ceilingShape)),
		FLOOR_FLAT_LIGHT = add("floor_flat_light", OmniItems.LIGHTING_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.GLASS).lightValue(15), carpetShape)),

		// CONSTRUCTION
		
		BEDRAILSIDE_ACACIA = add("bedrailside_acacia", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailsideShape)),
		BEDRAILSIDE_BIRCH = add("bedrailside_birch", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailsideShape)),
		BEDRAILSIDE_BLACK = add("bedrailside_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), bedrailsideShape)),
		BEDRAILSIDE_DARKOAK = add("bedrailside_darkoak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailsideShape)),
		BEDRAILSIDE_JUNGLE = add("bedrailside_jungle", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailsideShape)),
		BEDRAILSIDE_OAK = add("bedrailside_oak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailsideShape)),
		BEDRAILSIDE_SPRUCE = add("bedrailside_spruce", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailsideShape)),
		BEDRAILSIDE_WHITE = add("bedrailside_white", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), bedrailsideShape)),
		BEDRAILCORNER_ACACIA = add("bedrailcorner_acacia", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		BEDRAILCORNER_BIRCH = add("bedrailcorner_birch", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		BEDRAILCORNER_BLACK = add("bedrailcorner_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		BEDRAILCORNER_DARKOAK = add("bedrailcorner_darkoak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		BEDRAILCORNER_JUNGLE = add("bedrailcorner_jungle", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		BEDRAILCORNER_OAK = add("bedrailcorner_oak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		BEDRAILCORNER_SPRUCE = add("bedrailcorner_spruce", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		BEDRAILCORNER_WHITE = add("bedrailcorner_white", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), bedrailcornerShape)),
		CONCRETE_CEILING_BLACK = add("concrete_ceiling_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), ceilingShape)),
		CONCRETE_CEILING_LGRAY = add("concrete_ceiling_lgray", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), ceilingShape)),
		CONCRETE_CEILING_WHITE = add("concrete_ceiling_white", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), ceilingShape)),
		CONCRETE_TILE_BLACK = add("concrete_tile_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), carpetShape)),
		CONCRETE_TILE_LGRAY = add("concrete_tile_lgray", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), carpetShape)),
		CONCRETE_TILE_WHITE = add("concrete_tile_white", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), carpetShape)),
		...
		QUARTER_PILLAR_ACACIA = add("quarter_pillar_acacia", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), quarterpillarShape)),
		QUARTER_PILLAR_BIRCH = add("quarter_pillar_birch", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), quarterpillarShape)),
		QUARTER_PILLAR_BLACK = add("quarter_pillar_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), quarterpillarShape)),
		QUARTER_PILLAR_DARKOAK = add("quarter_pillar_darkoak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), quarterpillarShape)),
		QUARTER_PILLAR_JUNGLE = add("quarter_pillar_jungle", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), quarterpillarShape)),
		QUARTER_PILLAR_OAK = add("quarter_pillar_oak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), quarterpillarShape)),
		QUARTER_PILLAR_SPRUCE = add("quarter_pillar_spruce", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), quarterpillarShape)),
		QUARTER_PILLAR_WHITE = add("quarter_pillar_white", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), quarterpillarShape)),
		ROD_BLACK = add("rod_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), rodShape)),
		ROD_WHITE = add("rod_white", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), rodShape)),
		ROD_GRAY = add("rod_gray", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), rodShape)),
		ROD_LIGHT_GRAY = add("rod_light_gray", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.STONE), rodShape)),
		ROD_OAK = add("rod_oak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), rodShape)),
		ROD_BIRCH = add("rod_birch", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), rodShape)),
		ROD_SPRUCE = add("rod_spruce", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), rodShape)),
		ROD_DARK_OAK = add("rod_dark_oak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), rodShape)),
		ROD_ACACIA = add("rod_acacia", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), rodShape)),	
		ROD_JUNGLE = add("rod_jungle", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), rodShape)),
		CORNER_HALF_WALL_ACACIA = add("corner_half_wall_acacia", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_ANDESITE = add("corner_half_wall_andesite", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_BIRCH = add("corner_half_wall_birch", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_BLACK = add("corner_half_wall_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_DARKOAK = add("corner_half_wall_darkoak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_DIORITE = add("corner_half_wall_diorite", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_GRANITE = add("corner_half_wall_granite", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_JUNGLE = add("corner_half_wall_jungle", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_OAK = add("corner_half_wall_oak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_SPRUCE = add("corner_half_wall_spruce", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_STONE = add("corner_half_wall_stone", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_HALF_WALL_WHITE = add("corner_half_wall_white", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerhalfwallShape)),
		CORNER_WALL_ACACIA = add("corner_wall_acacia", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_ANDESITE = add("corner_wall_andesite", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_BIRCH = add("corner_wall_birch", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_BLACK = add("corner_wall_black", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_DARKOAK = add("corner_wall_darkoak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_DIORITE = add("corner_wall_diorite", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_GRANITE = add("corner_wall_granite", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_JUNGLE = add("corner_wall_jungle", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_OAK = add("corner_wall_oak", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_SPRUCE = add("corner_wall_spruce", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		CORNER_WALL_STONE = add("corner_wall_stone", OmniItems.CONSTRUCTION_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), cornerwallShape)),
		...
		STAIRS_ACACIA = add("stairs_acacia", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_BIRCH = add("stairs_birch", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_BLACK = add("stairs_black", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_DARKOAK = add("stairs_darkoak", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_JUNGLE = add("stairs_jungle", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_OAK = add("stairs_oak", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_SPRUCE = add("stairs_spruce", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_WHITE = add("stairs_white", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_ANDESITE = add("stairs_andesite", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_DIORITE = add("stairs_diorite", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_GRANITE = add("stairs_granite", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
		STAIRS_STONE = add("stairs_stone", OmniItems.FIXTURES_TAB, new WateredHRBlock(Properties.create(Material.IRON).sound(SoundType.WOOD), modernstairShape)),
