...
public class ClockBlock extends HorizontalRotationBlock
{
	
	public static final VoxelShape NORTH_SHAPE = Block.makeCuboidShape(0d, 0d, 14d, 16d, 16d, 16d);
	...
	public static final VoxelShape WEST_SHAPE = Block.makeCuboidShape(14d, 0d, 0d, 16d, 16d, 16d);
